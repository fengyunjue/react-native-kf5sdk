...
public class HelpCenterTypeChildActivity extends BaseActivity<HelpCenterTypeChildPresenter, IHelpCenterTypeChildView> implements
        IHelpCenterTypeChildView, View.OnClickListener, View.OnKeyListener,
    ...
    @Override
    public Loader<HelpCenterTypeChildPresenter> onCreateLoader(int id, Bundle args) {
        return new PresenterLoader<>(this, new PresenterFactory<HelpCenterTypeChildPresenter>() {
            @Override
    ...
    @Override
    public void onLoadFinished(Loader<HelpCenterTypeChildPresenter> loader, HelpCenterTypeChildPresenter data) {
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        ...
        if (lastItem == listItem.size() && scrollState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE) {
            if (nextPage != -100 && nextPage != 1) {
                ...
                else presenter.getPostListById(HelpCenterRequestType.DEFAULT);
            } else {
